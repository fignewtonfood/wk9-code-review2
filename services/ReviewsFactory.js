nicksFlicks.factory('ReviewsFactory', function ReviewsFactory(){
    ...
    factory.reviews =  [ { title: "Hackers is the best movie ever!",
                         ...
                         { title: "My thoughts on the new Star Wars",
                            text: "Gumbo beet greens corn soko endive gumbo gourd. Parsley shallot courgette tatsoi pea sprouts fava bean collard greens dandelion okra wakame tomato. Dandelion cucumber earthnut pea peanut soko zucchini.", id: 3 },
                         ...
                         { title: "Seriously, don't every see Garden State",
                            text: "Hodor. Hodor hodor hodor - hodor?! Hodor hodor HODOR! Hodor HODOR hodor, hodor hodor, hodor. Hodor hodor. Hodor. Hodor, hodor. Hodor. Hodor, hodor, hodor. Hodor hodor hodor! Hodor hodor, hodor. Hodor hodor. Hodor. Hodor hodor - hodor... Hodor hodor hodor... Hodor hodor hodor hodor hodor hodor! Hodor HODOR hodor, hodor hodor, hodor, hodor hodor. Hodor hodor, hodor. Hodor hodor, hodor, hodor hodor.", id: 6 }
                       ];

    // student constructor
    factory.addReview = function() {
        factory.reviews.push({ title: factory.reviewTitle, text: factory.reviewText, id: factory.reviews.length + 1});
